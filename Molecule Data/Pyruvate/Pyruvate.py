...
molGamma = [muC, 0, 0, 0, 0, 0, muH, muH, muH] #1-13C
#molGamma = [muC, 0, 0, 0, 0, 0, muD, muD, muD] #1-13C Deuterated
#molGamma = [0, 0, 0, 0, 0, muC, muH, muH, muH] #3-13C
#molGamma = [0, 0, 0, 0, 0, muC, muD, muD, muD] #3-13C Deiterated